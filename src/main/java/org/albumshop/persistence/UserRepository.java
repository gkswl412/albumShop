...
public interface UserRepository extends CrudRepository<User, String>{
    ...
    @Query(value="SELECT c.title, a.quantity from cart_detail a join cart b on a.cart_id=b.id join album c on a.album_id = c.id where b.user_id = ?1", nativeQuery = true)
